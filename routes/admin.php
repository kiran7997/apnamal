...
Route::group(['prefix'=>'admin/media','middleware' => 'auth','namespace' => 'AdminControllers'], function () {
  ...
  Route::get('/detailimage/{id}', 'MediaController@detailimage');
...
Route::group(['prefix'=>'admin/products','namespace' => 'AdminControllers'], function () {
  Route::get('/display', 'ProductController@display');
  Route::get('/pending', 'ProductController@pending');
  
  Route::get('/approveProduct/{id}','ProductController@approveProduct');
  Route::get('/declineProduct/{id}','ProductController@declineProduct');
...
//faq
Route::group(['prefix'=>'admin/faq','middleware' => 'auth','namespace' => 'AdminControllers'], function () {
  Route::get('/display', 'FaqController@display');
  Route::get('/add', 'FaqController@add');
  Route::post('/add', 'FaqController@insert');
  Route::get('/edit/{id}', 'FaqController@edit');
  Route::post('/update', 'FaqController@update');
  Route::post('/delete', 'FaqController@delete');
  Route::get('/filter', 'FaqController@filter');
});
...
Route::group(['prefix'=>'admin/zones','middleware' => 'auth','namespace' => 'AdminControllers'], function () {
  ...
  Route::get('/pincodes/display', 'ZonesController@pincodesindex')->middleware('view_tax');
  Route::get('/pincodes/filter', 'ZonesController@pincodesfilter')->middleware('view_tax');
  Route::get('/pincodes/import', 'ZonesController@pincodesimport')->middleware('add_tax');
  Route::post('/pincodes/import', 'ZonesController@pincodes_import')->middleware('add_tax');
  Route::get('/pincodes/add', 'ZonesController@pincodesadd')->middleware('add_tax');
  Route::post('/pincodes/add', 'ZonesController@pincodesinsert')->middleware('add_tax');
  Route::get('/pincodes/edit/{id}', 'ZonesController@pincodesedit')->middleware('edit_tax');
  Route::post('/pincodes/update', 'ZonesController@pincodesupdate')->middleware('edit_tax');
  Route::post('/pincodes/delete', 'ZonesController@pincodesdelete')->middleware('delete_tax');
});
...
Route::group(['prefix'=>'admin/orders','middleware' => 'auth','namespace' => 'AdminControllers'], function () {
  Route::get('/display', 'OrdersController@display');
  Route::get('/returns', 'OrdersController@getReturns');
  ...
  Route::get('/orderstatus', 'SiteSettingController@orderstatus');
  ...
  Route::get('/approveReturn/{id}','OrdersController@approveOrderReturn');
  Route::get('/declineReturn/{id}','OrdersController@declineOrderReturn');
});
...
////////////////////////////////////////////////////////////////////////////////////
      ...
      /******************************Home Comic Section****************************************/
       Route::get('/home-comic', 'SiteSettingController@home_comic');
       Route::post('/home-comic', 'SiteSettingController@homecomic');
       
       Route::get('/about-us', 'AboutController@about_us');
       Route::post('/about-us', 'AboutController@aboutus');
       Route::get('/donations', 'AboutController@donations');
       Route::get('/donation/{id}', 'AboutController@donation');
       Route::get('/donation/{id}/{status}', 'AboutController@donation_status');
       Route::get('/memberships', 'AboutController@memberships');
       Route::get('/membership/{id}', 'AboutController@membership');
       Route::get('/membership/{id}/{status}', 'AboutController@membership_status');
       
       Route::get('/blog-category', 'BlogController@blogcategory');
       Route::get('/add-category', 'BlogController@addcategory');
       Route::post('/add-category', 'BlogController@add_category');
       Route::get('/edit-category/{id}', 'BlogController@edit_category');
       Route::post('/update-category', 'BlogController@update_category');
       Route::get('/delete-category/{id}', 'BlogController@delete_category');
       
       Route::get('/blog', 'BlogController@blog');
       Route::get('/add-blog', 'BlogController@addblog');
       Route::post('/add-blog', 'BlogController@add_blog');
      ...
      /******************************Home Comic Section****************************************/
       ...
       /**********************************Vendors****************************************/
        ...
        Route::get('/vendor-status-update/{id}', 'VendorController@vendorstatus');
        Route::get('/filter', 'VendorController@filter');
        Route::get('/delete/{id}', 'VendorController@delete');
        Route::get('/view-earning/{id}', 'VendorController@view_earning');
        Route::get('/vendor/withdrawal/request/{id}', 'VendorController@vendor_withdrawal_request');
        Route::get('/withdrawal', 'VendorController@withdrawal');
        Route::post('/withdrawal', 'VendorController@Postwithdrawal');
        Route::post('/status-withdrawal', 'VendorController@statuswithdrawal');
       /**********************************Vendors****************************************/
...
//units
    ...
    Route::post('/deleteOrderStatus', 'SiteSettingController@deleteOrderStatus')->middleware('edit_general_setting');
     ...
     Route::get('/googlesettings', 'SiteSettingController@googleSettings')->middleware('view_general_setting');
      ...
      Route::get('/advertisement', 'SiteSettingController@advertisement');
      Route::post('/advertisement', 'SiteSettingController@Postadvertisement');
      //pushNotification
