    ...
    public function paginator(){
      ...
      $categories = Categories::sortable(['categories_id'=>'ASC'])
           ->leftJoin('categories_description','categories_description.categories_id', '=', 'categories.categories_id')
            ...
            ->select('categories.categories_id as id','categories.level as level','categories.parent_id as parent_id',// 'categories.categories_image as image',
...
//            })
    ...
    public function insert($uploadImage,$date_added,$parent_id,$uploadIcon,$categories_status,$level){
    ...
    public function updaterecord($categories_id,$uploadImage,$uploadIcon,$last_modified,$parent_id,$slug,$categories_status,$level){
