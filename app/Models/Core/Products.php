...
class Products extends Model
{
  ...
  public function insert($request){
    ...
    if (!empty($request->vendor)) {
        ...
        'products_mrp' => $request->products_mrp,
        ...
        'buy_for_rent'         => $request->buy_for_rent,
        'security_15days'         => $request->security_15days,
        'security_30days'         => $request->security_30days,
        'security_2months'         => $request->security_2months,
        'security_3months'         => $request->security_3months,
        'security_6months'         => $request->security_6months,
        'security_1year'         => $request->security_1year,
    ]);
