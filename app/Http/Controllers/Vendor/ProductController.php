...
class ProductController extends Controller
{
  ...
  public function display(Request $request){
      ...
      if(Auth::guard('customer')->user()->user_type == 2){
          $products = $this->products->where('products.vendor', '=', Auth::guard('customer')->user()->user_type == 2)->paginate(100);
      }else{
          $products = $this->products->paginate(100);
      }
      ...
      return view("products.index",$title)->with('results', $results)->with('categories_id',$categories_id)->with('product',$product);
  ...
  public function add(Request $request){
     ...
     return view("products.add", $title)->with('result', $result)->with('allimage',$allimage);
  ...
  public function edit(Request $request){
    ...
    return view("products.edit", $title)->with('result', $result)->with('allimage',$allimage);
  ...
  public function update(Request $request){
    ...
    if($request->products_type==1){
      return redirect('vendor/products/attach/attribute/display/'.$products_id);
    }else{
      return redirect('vendor/products/images/display/'.$products_id);
    }
  }
  ...
  public function addinventory(Request $request){
      ...
      return view("products.inventory.add", $title)->with('result', $result);
  ...
  public function ajax_attr($id){
      ...
      return view("products.inventory.attribute_div")->with('result', $result);
  ...
  public function addinventoryfromsidebar(Request $request){
      ...
      return view("products.inventory.add1", $title)->with('result', $result);
