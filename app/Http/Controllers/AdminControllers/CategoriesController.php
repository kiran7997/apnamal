...
//    die;
  ...
  public function insert(Request $request){
        ...
        if($parent_id > 0){
           $parent_level = DB::table('categories')->where('categories_id',$request->parent_id)->value('level');
           if($parent_level==0){
               $level = 1;
           }elseif($parent_level==1){
               $level = 2;
           }
        }else{
            $level = 0;
        ...
        $categories_id = $this->Categories->insert($uploadImage,$date_added,$parent_id,$uploadIcon,$categories_status,$level);
        $slug_flag = false;
  ...
  //  dd($editSubCategory[0]->parent_id);
   ...
   public function update(Request $request){
     ...
     $updateCategory = $this->Categories->updaterecord($categories_id,$uploadImage,$uploadIcon,$last_modified,$parent_id,$slug,$categories_status,$level);
