   ...
   //googleSettings
    ...
    public function addNewOrderStatus(Request $request){
		...
		$result['languages'] = $myVar->getter();
           /*     
               $advertisements = DB::table('advertisements')
                       ->leftJoin('image_categories','advertisements.home_right_1','=','image_categories.image_id')
            ...
            return view('admin.Advertisement.advertisement',$title)->with(['result' => $result,'allimage' => $allimage,'advertisements'=>$advertisements]);
        }
        ...
        public function Postadvertisement(Request $request)
        {
            ...
            if ($request->home_right_1) {
                $home_right_1 = $request->home_right_1;
            } else {
                $home_right_1 = '';
            }
            
            if ($request->home_right_2) {
                $home_right_2 = $request->home_right_2;
            } else {
                $home_right_2 = '';
            }
        ...
        public function home_comic(Request $request)
        {
            $images  = new Images();
            $result = array();
            $allimage = $images->getimages();
            
            $comic = DB::table('home_page')->where('id',1)->first();
        ...
        public function homecomic(Request $request)
        {
            $images  = new Images();
            $allimage = $images->getimages();
            ...
            DB::table('home_page')->where('id',1)->update([
                                'comic_img' => $image,
                                'title' => $request->title,
