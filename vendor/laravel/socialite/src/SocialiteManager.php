...
class SocialiteManager extends Manager implements Contracts\Factory
{
    ...
    protected function createFacebookDriver()
    {
        ...
        $config = array(
            'client_id'=>$settings[0]->value,
            'client_secret'=>$settings[1]->value,
            'redirect'=>$settings[114]->value,
        );
    ...
    protected function createGoogleDriver()
    {
        ...
        $config = array(
            'client_id'=>$settings[115]->value,
            'client_secret'=>$settings[116]->value,
            'redirect'=>$settings[117]->value,
        );
        //echo $settings[117]->value; die; 
        //print_r($config); die;
        return $this->buildProvider(
