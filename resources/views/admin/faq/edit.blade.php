...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ URL::to('admin/faq/display')}}"><i class="fa fa-users"></i> Listing All The FAQ's</a></li>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    <!-- form start -->
                                    <div class="box-body">
                                        {!! Form::open(array('url' =>'admin/faq/update', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                                        {!! Form::hidden('faq_id', $faq->id, array('class'=>'form-control', 'id'=>'id')) !!}
                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 col-md-3 control-label">Title* </label>
                                            <div class="col-sm-8 col-md-8">
                                                {!! Form::text('title', $faq->title, array('class'=>'form-control field-validate', 'id'=>'title')) !!}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8 col-md-8">
                                                <textarea class="form-control field-validate" rows="3" name="description" id="description">{!!$faq->description!!}</textarea>
