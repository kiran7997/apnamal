              ...
              <div class=" active tab-pane" id="profile">
    			...
    			<div class="col-sm-10">
                    ...
                    @if(Auth::user()->user_type == 2)
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="company" required value="{{Auth::user()->company}}"/> 
                        </div>
                      </div>
                    @else
                ...
                @if(Auth::user()->user_type == 2)
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" rows="7" name="company_description">{{Auth::user()->company_description}}</textarea>
                        </div>
                      </div>
                  @else
               ...
               <div class="form-group">
                   ...
                   <div class="col-sm-10">
                    ...
                    @if(!empty(Auth::user()->avatar))
                       <img src="{{URL::asset('/'.Auth::user()->avatar)}}" width="100px"/> 
                     @endif
                   </div>
               </div>
             @else
             ...
             @endif
                ...
                @if(Auth::user()->user_type == 2)
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="facebook_link" required value="{{Auth::user()->facebook_link}}"/>
                        </div>
                      </div>
                    @else
                    ...
                    @if(Auth::user()->user_type == 2)
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="twitter_link" required value="{{Auth::user()->twitter_link}}"/>
                        </div>
                      </div>
                    @else
                 ...
                 @if(Auth::user()->user_type == 2)
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="linkdein_link" required value="{{Auth::user()->linkdein_link}}"/>
                        </div>
                    </div>
                    @else
                 ...
                 @if(Auth::user()->user_type == 2)
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="rss_link" required value="{{Auth::user()->rss_link}}"/>
                        </div>
                      </div> 
                    @else
