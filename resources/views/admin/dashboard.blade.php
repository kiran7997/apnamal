        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-lg-3 col-xs-6">
                  ...
                  <div class="small-box bg-aqua">
                    <div class="inner">
                        <h4>{{ $result['currency'][19]->value }} <b>{{ number_format($result['sold_cost_vendor_completed'],2) }}</b></h4>
                        <p>Total Earnings</p>
                    </div>
                    <div class="icon">
                      <i class="ion ion-bag"></i>
                ...
                <div class="col-lg-3 col-xs-6">
                  ...
                  <div class="small-box bg-light-blue">
                    <div class="inner">
                        <h4>{{ $result['currency'][19]->value }} <b>{{ number_format(($result['sold_cost_vendor']*$result['settings'][118]->value)/100,2) }}</b></h4>
                        <p>Admin Charge</p>
                    </div>
                    <div class="icon">
                      <i class="ion ion-bag"></i>
                ...
                <div class="col-lg-3 col-xs-6">
                  ...
                  <div class="small-box bg-teal">
                    <div class="inner">
                        <h4>{{ $result['currency'][19]->value }} <b>{{ number_format($result['sold_cost_vendor_pending'],2) }}</b></h4>
                                            ...
                                            ?>
                                                @if($key<=10)
                                                    <tr>
                                                        ...
                                                        <td>{{ $orders->customers_name }}</td>
                                                       @if(Auth::user()->user_type == 2)
                                                        <td>{{ $result['currency'][19]->value }}{{ floatval($price) }} </td>
                                                        @else
                                                        <td>{{ $result['currency'][19]->value }}{{ floatval($orders->total_price) }} </td>
                                                      @endif
                                                        <td>
