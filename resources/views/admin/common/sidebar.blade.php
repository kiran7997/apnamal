<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview {{ Request::is('admin/orders/returns') ? 'active' : '' }}">
                <a href="{{ URL::to('admin/orders/returns')}}">
                    <i class="fa fa-list-ul" aria-hidden="true"></i><span>Returns</span>
                </a> 
        </li>
        @if(Auth()->user()->id == 1)
        <li class=" treeview {{ Request::is('admin/products/pending') ? 'active' : '' }}">
            <a href="{{ URL::to('admin/products/pending')}}">
...
<?php
      ...
      <?php }  ?>
    @if(Auth()->user()->id == 1)
        <li class="treeview {{ Request::is('admin/vendor') ? 'active' : '' }} {{ Request::is('admin/edit/*') ? 'active' : '' }} {{ Request::is('admin/view-earning/*') ? 'active' : '' }} {{ Request::is('admin/vendor/withdrawal/request/*') ? 'active' : '' }}">
      ...
      ?>
        <li class="treeview {{ Request::is('admin/products/display') ? 'active' : '' }} {{ Request::is('admin/products/add') ? 'active' : '' }} {{ Request::is('admin/products/edit/*') ? 'active' : '' }} {{ Request::is('admin/editattributes/*') ? 'active' : '' }} {{ Request::is('admin/products/attributes/display') ? 'active' : '' }}  {{ Request::is('admin/products/attributes/add') ? 'active' : '' }} {{ Request::is('admin/products/attributes/add/*') ? 'active' : '' }} {{ Request::is('admin/addinventory/*') ? 'active' : '' }} {{ Request::is('admin/addproductimages/*') ? 'active' : '' }} {{ Request::is('admin/categories/display') ? 'active' : '' }} {{ Request::is('admin/categories/add') ? 'active' : '' }} {{ Request::is('admin/categories/edit/*') ? 'active' : '' }} {{ Request::is('admin/categories/filter') ? 'active' : '' }} {{ Request::is('admin/products/inventory/display') ? 'active' : '' }}">
          ...
          <ul class="treeview-menu">
            ...
            @if (@$check->products_view == 1  or Auth()->user()->user_type == 2)
      ...
      <?php } ?>
        ...
        <li class="treeview {{ Request::is('admin/withdrawal') ? 'active' : '' }}">
            <a href="{{ URL::to('admin/withdrawal')}}">
        ...
        @if(Auth::user()->id == 1)
        <li class="treeview {{ Request::is('admin/donations') ? 'active' : '' }}">
            <a href="{{ URL::to('admin/donations')}}">
                <i class="fa fa-user" aria-hidden="true"></i><span>Donations</span>
            </a> 
        </li>
        <li class="treeview {{ Request::is('admin/memberships') ? 'active' : '' }} {{ Request::is('admin/memberships/*') ? 'active' : '' }} {{ Request::is('admin/membership/*/*') ? 'active' : '' }}">
            <a href="{{ URL::to('admin/memberships')}}">
     ...
     @if(Auth()->user()->id == 1)
            <li class="treeview {{ Request::is('admin/about-us') ? 'active' : '' }}">
                <a href="#">
                    <i class="fa fa-database" aria-hidden="true"></i>
                    <span>About Us</span> <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                    <li class="{{ Request::is('admin/about-us') ? 'active' : '' }}"><a href="{{ URL::to('admin/about-us')}}"><i class="fa fa-circle-o"></i>About Us</a></li>
                </ul>
            </li>
      @endif
      
     @if(Auth()->user()->id == 1)
            <li class="treeview {{ Request::is('admin/blog-category') ? 'active' : '' }} {{ Request::is('admin/add-category') ? 'active' : '' }} {{ Request::is('admin/edit-category/*') ? 'active' : '' }}
                {{ Request::is('admin/blog') ? 'active' : '' }} {{ Request::is('admin/add-blog') ? 'active' : '' }} {{ Request::is('admin/edit-blog/*') ? 'active' : '' }} ">
                <a href="#">
                    <i class="fa fa-database" aria-hidden="true"></i>
                    <span>Blog</span> <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                    <li class="{{ Request::is('admin/blog-category') ? 'active' : '' }} {{ Request::is('admin/add-category') ? 'active' : '' }} {{ Request::is('admin/edit-category/*') ? 'active' : '' }}"><a href="{{ URL::to('admin/blog-category')}}"><i class="fa fa-circle-o"></i>Category</a></li>
                    <li class="{{ Request::is('admin/blog') ? 'active' : '' }} {{ Request::is('admin/add-blog') ? 'active' : '' }} {{ Request::is('admin/edit-blog/*') ? 'active' : '' }}"><a href="{{ URL::to('admin/blog')}}"><i class="fa fa-circle-o"></i>Blog</a></li>
                </ul>
            </li>
      @endif
      ...
      ?>
        ...
        <li class="treeview {{ Request::is('admin/faq/display') ? 'active' : '' }}  {{ Request::is('admin/faq/add') ? 'active' : '' }}  {{ Request::is('admin/faq/edit/*') ? 'active' : '' }} {{ Request::is('admin/faq/filter') ? 'active' : '' }} ">
          <a href="{{ URL::to('admin/faq/display')}}">
        ...
        ?>
          <li class="treeview {{ Request::is('admin/countries/display') ? 'active' : '' }} {{ Request::is('admin/countries/add') ? 'active' : '' }} {{ Request::is('admin/countries/edit/*') ? 'active' : '' }} {{ Request::is('admin/zones/display') ? 'active' : '' }} {{ Request::is('admin/zones/add') ? 'active' : '' }} {{ Request::is('admin/zones/eidt/*') ? 'active' : '' }} {{ Request::is('admin/tax/taxclass/display') ? 'active' : '' }} {{ Request::is('admin/tax/taxclass/add') ? 'active' : '' }} {{ Request::is('admin/tax/taxclass/edit/*') ? 'active' : '' }} {{ Request::is('admin/tax/taxrates/display') ? 'active' : '' }} {{ Request::is('admin/tax/taxrates/add') ? 'active' : '' }} {{ Request::is('admin/tax/taxrates/edit/*') ? 'active' : '' }}">
            ...
            <ul class="treeview-menu">
              ...
              <li class="{{ Request::is('admin/zones/pincodes/display') ? 'active' : '' }} {{ Request::is('admin/zones/pincodes/add') ? 'active' : '' }} {{ Request::is('admin/zones/pincodes/eidt/*') ? 'active' : '' }}"><a href="{{ URL::to('admin/zones/pincodes/display')}}"><i class="fa fa-circle-o"></i> Pincodes</a></li>
...
<span>{{ trans('labels.link_notifications') }}</span> <i class="fa fa-angle-left pull-right"></i>
  ...
  <span> {{ trans('labels.link_site_settings') }}</span> <i class="fa fa-angle-left pull-right"></i>
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ Request::is('admin/home-comic') ? 'active' : '' }}"><a href="{{ URL::to('admin/home-comic')}}"><i class="fa fa-circle-o"></i>Home Page Comic</a></li>
          </ul>
        </li>
      <?php } ?>
      <?php
  ...
  <span> {{ trans('labels.link_general_settings') }}</span> <i class="fa fa-angle-left pull-right"></i>
          ...
          <ul class="treeview-menu">
            ...
            <li class="{{ Request::is('admin/advertisement') ? 'active' : '' }}"><a href="{{ URL::to('admin/advertisement')}}"><i class="fa fa-circle-o"></i> Advertisement</a></li>
