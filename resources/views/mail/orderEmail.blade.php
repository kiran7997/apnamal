    ...
    <tbody style="text-transform: capitalize;font-size: 12px;">
     @foreach($ordersData['orders_data'][0]->data as $key=>$products)
      ...
      <?php $product_image = DB::table('image_categories')->where('image_id',$products->image)->where('image_type','THUMBNAIL')->first(); ?>
        ...
        @if($key%2==0) <td align="center" style="border-top: 1px solid #f4f4f4; padding: 8px;"> @else <td align="center" style="padding: 8px;"> @endif<img src="{{ !empty($product_image) ? asset('').$product_image->path : null }}" width="60px"> </td>
