<header class="main-header">
    ...
    <a href="<?php echo e(URL::to('admin/dashboard/this_month')); ?>" class="logo">
      ...
      <span class="logo-mini" style="font-size:12px"><b>Vendor</b></span>
      <?php else: ?>
      <span class="logo-mini" style="font-size:12px"><b><?php echo e(trans('labels.admin')); ?></b></span>
      <?php endif; ?>
      <!-- logo for regular state and mobile devices -->
      <?php if(Auth::user()->user_type == 2): ?>
      <span class="logo-lg"><b>Vendor</b></span>
        <?php else: ?>
...
"></div>
      ...
      <div class="navbar-custom-menu">
        ...
        <?php if(Auth::user()->user_type == 2  or Auth::user()->user_type == 1): ?>
        <?php else: ?>
  ...
  </header><?php /**PATH /home/cwwwqrxa/domains/apnamal.com/public_html/resources/views/admin/common/header.blade.php ENDPATH**/ ?>