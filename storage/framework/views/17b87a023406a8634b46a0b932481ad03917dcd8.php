        ...
        <table class="table ps-table">
            <thead>
                ...
                <tbody>
                    ...
                    <?php if(count($order[0]['products'])>0): ?>
                    <?php $__currentLoopData = $order[0]['products']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
            ...
            <div class="alert alert-danger" id="error_div" style="display:none;">
                ...
                <?php echo Form::open(array('url' => 'submit-return','autocomplete'=>'off','role'=>'form','enctype' => 'multipart/form-data', 'id' => 'requestForm','name' => 'requestForm')); ?>

                    <div class="form-group">
                        <label for="reasons" class="form-control-label">Reasons for returning :</label>
                        <input type="hidden" name="id" value="<?php echo e($id); ?>"/>
                        <input type="hidden" name="orders_products_id" value="<?php echo e($orders_products_id); ?>"/>
...
<script>
    function submitForm() {
       ...
       <?php /**PATH /home/adfsddf/public_html/library/resources/views/web/returnModal.blade.php ENDPATH**/ ?>