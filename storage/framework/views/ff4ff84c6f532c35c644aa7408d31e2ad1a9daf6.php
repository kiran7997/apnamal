                        ...
                        <div class="box-header">
                            ...
                            <!--  <div class="container-fluid">
                             ...
                             <div class="box-tools pull-right">
                                <a href="<?php echo e(url('admin/add-category')); ?>" type="button" class="btn btn-block btn-primary">Add Category</a>
                            </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="row">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                     ...
                                     <?php if(count($categories)>0): ?>  
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a data-toggle="tooltip" data-placement="bottom" title="Edit" href="<?php echo e(url('admin/edit-category/'.$category->id)); ?>" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                                <a  href="<?php echo e(url('admin/delete-category/'.$category->id)); ?>" title="Delete" onclick="return confirm('Are you sure you want to delete this item?');" class="badge bg-red"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                            </td>
                                        </tr>
                                         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                      <?php endif; ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cwwwqrxa/domains/apnamal.com/public_html/resources/views/admin/Blog/blogcategory.blade.php ENDPATH**/ ?>