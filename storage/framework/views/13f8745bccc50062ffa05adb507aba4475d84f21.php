                                ...
                                <div class="col-xs-12">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <th><?php echo e(trans('labels.Status Type')); ?></th>
                                        ...
                                        <?php $__currentLoopData = $result['orders_status']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $OrderStatus): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td>
                                                  <?php if($OrderStatus->role_id==2): ?> <span  class="badge bg-light-blue"><?php echo e(trans('labels.General')); ?></span>  <?php endif; ?>
                                                  <?php if($OrderStatus->role_id==3): ?> <span  class="badge bg-green"><?php echo e(trans('labels.Vendors')); ?></span>  <?php endif; ?>
                                                  <?php if($OrderStatus->role_id==4): ?> <span  class="badge bg-grey"> <?php echo e(trans('labels.Delivery Boy')); ?></span>  <?php endif; ?>
                                                </td>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cwwwqrxa/domains/apnamal.com/public_html/resources/views/admin/Orders/orderstatus.blade.php ENDPATH**/ ?>