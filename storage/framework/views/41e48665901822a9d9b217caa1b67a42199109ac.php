                            ...
                            <div class="col-xs-12">
                                <div class="box box-info">
                                  ...
                                  <?php if(Auth::user()->user_type == 2): ?>
                                    <input type="hidden" name="vendor" value="<?php echo e(Auth::user()->id); ?>"/>
                                    <?php else: ?>
                                        <div class="row">
                                            <?php
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        <select class="form-control" name="vendor">
                                                          ...
                                                          <?php if(count($vendors)>0): ?>
                                                            ...
                                                            <option value="<?php echo e($vendor->id); ?>"<?php if($result['product'][0]->vendor == $vendor->id ): ?> selected <?php endif; ?>><?php echo e($vendor->first_name); ?>  <?php echo e($vendor->last_name); ?></option>
                                                             <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                          <?php endif; ?>
                                                        </select>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        <?php echo Form::text('products_mrp', $result['product'][0]->products_mrp, array('class'=>'form-control number-validate', 'id'=>'products_mrp')); ?>
                                                   ...
                                                   <label for="name" class="col-sm-2 col-md-3 control-label">Buy For Rent</label>
                                                    <div class="col-sm-10 col-md-8">
                                                        <select class="form-control" name="buy_for_rent" id="isFlash">
                                                            <option value="New Book"<?php if($result['product'][0]->buy_for_rent == $result['product'][0]->buy_for_rent && $result['product'][0]->buy_for_rent == "New Book"): ?> selected <?php endif; ?>>New Book</option>
                                                            <option value="Very Good"<?php if($result['product'][0]->buy_for_rent == $result['product'][0]->buy_for_rent && $result['product'][0]->buy_for_rent == "Very Good"): ?> selected <?php endif; ?>>Very Good</option>
                                                            <option value="Good"<?php if($result['product'][0]->buy_for_rent == $result['product'][0]->buy_for_rent && $result['product'][0]->buy_for_rent == "Good"): ?> selected <?php endif; ?>>Good</option>
                                                            <option value="Fair"<?php if($result['product'][0]->buy_for_rent == $result['product'][0]->buy_for_rent && $result['product'][0]->buy_for_rent == "Fair"): ?> selected <?php endif; ?>>Fair</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-md-6">
                                                <div class="form-group special-link">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10 col-md-8">
                                                            <input class="form-control" type="text" name="security_15days" id="security_15days" value="<?php echo e($result['product'][0]->security_15days); ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="name" class="col-sm-2 col-md-3 control-label">Security For 30 Days</label>
                                                        <div class="col-sm-10 col-md-8">
                                                            <input class="form-control" type="text" name="security_30days" id="security_30days" value="<?php echo e($result['product'][0]->security_30days); ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="name" class="col-sm-2 col-md-3 control-label">Security For 2 Months</label>
                                                        <div class="col-sm-10 col-md-8">
                                                            <input class="form-control" type="text" name="security_2months" id="security_2months" value="<?php echo e($result['product'][0]->security_2months); ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="name" class="col-sm-2 col-md-3 control-label">Security For 3 Months</label>
                                                        <div class="col-sm-10 col-md-8">
                                                            <input class="form-control" type="text" name="security_3months" id="security_3months" value="<?php echo e($result['product'][0]->security_3months); ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="name" class="col-sm-2 col-md-3 control-label">Security For 6 Months</label>
                                                        <div class="col-sm-10 col-md-8">
                                                            <input class="form-control" type="text" name="security_6months" id="security_6months" value="<?php echo e($result['product'][0]->security_6months); ?>">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="name" class="col-sm-2 col-md-3 control-label">Security For 1 Year</label>
                                                        <div class="col-sm-10 col-md-8">
                                                            <input class="form-control" type="text" name="security_1year" id="security_1year" value="<?php echo e($result['product'][0]->security_1year); ?>">
                                                        </div>
                                                    </div>
                                            </div>
                                        </div>-->
                                                ...
                                                <div class="tabbable tabs-left">
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div style="margin-top: 15px;" class="tab-pane <?php if($j==0): ?> active <?php endif; ?>" id="product_<?=$description_data['languages_id']?>">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="name" class="col-sm-2 col-md-3 control-label"><?php echo e(trans('labels.ShortDescription')); ?> (<?php echo e($description_data['language_name']); ?>)</label>
                                                                <div class="col-sm-10 col-md-8">
                                                                    <textarea id="editor<?=$description_data['languages_id']?>" name="short_description" class="form-control"
                                                                      rows="5"><?php echo isset($short_description) ? stripslashes($short_description) : null; ?></textarea>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="name" class="col-sm-2 col-md-3 control-label"><?php echo e(trans('labels.Specification')); ?> (<?php echo e($description_data['language_name']); ?>)</label>
                                                                <div class="col-sm-10 col-md-8">
                                                                    <textarea id="editor2<?=$description_data['languages_id']?>" name="specification" class="form-control"
                                                                      rows="5"><?php echo isset($specification) ? stripslashes($specification) : null; ?></textarea>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cwwwqrxa/domains/apnamal.com/public_html/resources/views/admin/products/edit.blade.php ENDPATH**/ ?>