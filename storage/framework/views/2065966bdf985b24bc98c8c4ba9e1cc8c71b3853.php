                            ...
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label for="name"
                                                class="col-sm-2 col-md-3 control-label"><?php echo e(trans('labels.Currency')); ?>
                                        ...
                                        <div class="form-group">
                                            <label for="name"
                                                class="col-sm-2 col-md-3 control-label"><?php echo e(trans('labels.symbol_left')); ?>

                                            </label>
                                            <div class="col-sm-10 col-md-4">
                                                <?php echo Form::text('symbol_left', '', array('class'=>'form-control ',
                                                'id'=>'symbol_left')); ?>
                                        ...
                                        <div class="form-group">
                                            <label for="name"
                                                class="col-sm-2 col-md-3 control-label"><?php echo e(trans('labels.symbol_right')); ?>

                                            </label>
                                            <div class="col-sm-10 col-md-4">
                                                <?php echo Form::text('symbol_right', '', array('class'=>'form-control ',
                                                'id'=>'symbol_right')); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cwwwqrxa/domains/apnamal.com/public_html/resources/views/admin/currencies/add.blade.php ENDPATH**/ ?>