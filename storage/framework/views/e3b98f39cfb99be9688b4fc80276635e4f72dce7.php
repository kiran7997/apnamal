...
<div style="padding: 5px;">
  <div style="width: 100%; display: block">
    ...
    margin: 0 5px;
    display: none;
    "> Pending</span> <small style="font-size: 14px;float: right;padding-right: 12px;margin-top: 6px;"><?php echo e(trans('labels.OrderedDate')); ?>: <?php echo e(date('m/d/Y', strtotime($ordersData['orders_data'][0]->date_purchased))); ?></small> </h2>
  </div>
  ...
  <table class="table table-striped" style="width: 100%;background-color: transparent;margin: 15px 0 15px;">
    ...
    <tbody style="text-transform: capitalize;font-size: 12px;">
     <?php $__currentLoopData = $ordersData['orders_data'][0]->data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$products): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      ...
      <?php $product_image = DB::table('image_categories')->where('image_id',$products->image)->where('image_type','THUMBNAIL')->first(); ?>
        ...
        <?php if($key%2==0): ?> <td align="center" style="border-top: 1px solid #f4f4f4; padding: 8px;"> <?php else: ?> <td align="center" style="padding: 8px;"> <?php endif; ?><img src="<?php echo e(!empty($product_image) ? asset('').$product_image->path : null); ?>" width="60px"> </td>
...
<?php /**PATH /home/cwwwqrxa/domains/apnamal.com/public_html/resources/views//mail/orderEmail.blade.php ENDPATH**/ ?>