                                ...
                                <div class="col-xs-12">
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <?php echo Form::open(array('url' =>'admin/shippingmethods/updateShppingWeightPrice', 'method'=>'post', 'class' => 'form-horizontal', 'enctype'=>'multipart/form-data')); ?>
                                            ...
                                            <div class="box-footer">
                                                <a href="<?php echo e(URL::to('admin/shippingmethods/display')); ?>" type="button" class="btn btn-default pull-left"> <i class="fa fa-angle-left"></i> <?php echo e(trans('labels.back')); ?></a>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cwwwqrxa/domains/apnamal.com/public_html/resources/views/admin/shippingmethods/shppingbyweight.blade.php ENDPATH**/ ?>