...
<div class="ps-page--my-account">
    ...
    <div class="ps-my-account">
        <div class="container">
            <form class="ps-form--accounta ps-tab-root" action="<?php echo e(URL::to('/membership')); ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" placeholder="Enter Your Name" name="name" value="<?php echo e(old('name')); ?>" required>
                </div>
                <div class="form-group">
                    <label>Email<sup>*</sup></label>
                    <input class="form-control" type="text" placeholder="Your Email address" name="email" value="<?php echo e(old('email')); ?>" required>
                </div>
                <div class="form-group">
                    <label>Contact<sup>*</sup></label>
                    <input class="form-control" type="tel:" placeholder="Enter Your Mobile No." name="mobile" value="<?php echo e(old('mobile')); ?>" required>
                </div>
                <div class="form-group">
                    <label>Street Address 1<sup>*</sup></label>
                    <textarea class="form-control" type="" placeholder="Enter Your Address" name="address1" required><?php echo e(old('address1')); ?></textarea>
                </div>
                <div class="form-group">
                    <label>Street Address 2<sup>*</sup></label>
                    <textarea class="form-control" type="" placeholder="Enter Your Address" name="address2"><?php echo e(old('address2')); ?></textarea>
                </div>
                <div class="form-group">
                    <label>Alternate Phone No.<sup>*</sup></label>
                    <input class="form-control" type="tel:" placeholder="Enter Your Alternate Mobile No." name="phone" value="<?php echo e(old('phone')); ?>" required>
                </div>
                <div class="form-group">
                    ...
                    <div class="form-group__content">
                        <select name="zone_id" class="form-control" required>
                            ...
                            <?php $__currentLoopData = $zones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zone): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($zone->zone_id); ?>" <?php if(old('zone_id')==$zone->zone_id){echo 'selected';} ?>><?php echo e($zone->zone_name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
                        </select>
                    </div>
...
<!--                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" placeholder="Enter Your city" value="<?php echo e(old('city')); ?>" name="city" required>
                </div>
                <div class="form-group">
                    <label>ZIP / Postal Code<sup>*</sup></label>
                    <input class="form-control" type="text" placeholder="Enter Your zip or postal Code" value="<?php echo e(old('pincode')); ?>" name="pincode" required>
                </div>
                    ...
                    <div class="form-group__content">
                        <select name="book" class="form-control">
                            ...
                            <?php $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($book->products_id); ?>" <?php if(old('book')==$book->products_id){echo 'selected';} ?>><?php echo e($book->products_name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
                        </select>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control row-5" name="how_to_find" placeholder="How did you find us?"><?php echo e(old('how_to_find')); ?></textarea>
                </div>
                <div class="form-group">
...
<?php echo $__env->make('web.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/adfsddf/public_html/library/resources/views/web/membership.blade.php ENDPATH**/ ?>