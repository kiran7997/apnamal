                                ...
                                <div class="col-xs-12">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <tr>
                                                    <td>1</td>
                                                    <td><?php echo e($adminvendors->first_name); ?></td>
                                                    <td><?php echo e($adminvendors->email); ?></td>
                                                    <td><?php echo e($adminvendors->phone); ?></td>
                                                    <td><?php echo e($adminvendors->company); ?></td>
                                                    <td>
                                                        <a data-toggle="tooltip" data-placement="bottom" title="Edit" href="<?php echo e(URL::to('admin/edit/1')); ?>" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                                    </td>
                                                </tr>
                                         <?php if(count($vendors)>0): ?>
                                            <?php $__currentLoopData = $vendors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i=> $vendor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td><?php echo e($i+2); ?></td>
                                                    <td><?php echo e($vendor->first_name); ?></td>
                                                    <td><?php echo e($vendor->email); ?></td>
                                                    <td><?php echo e($vendor->phone); ?></td>
                                                    <td><?php echo e($vendor->company); ?></td>
                                                     <!-- <td>
                                                      <?php if($vendor->status == 1): ?>
                                                        <a href="<?php echo e(url('admin/vendor-status-update/'.$vendor->id)); ?>" class="btn btn-success">Active</a>
                                                          <?php else: ?>
                                                        <a href="<?php echo e(url('admin/vendor-status-update/'.$vendor->id)); ?>" class="btn btn-danger">InActive</a>
                                                       <?php endif; ?>
                                                    </td>-->
                                                    <td>
                                                        <a data-toggle="tooltip" data-placement="bottom" title="Edit" href="<?php echo e(URL::to('admin/edit/'.$vendor->id)); ?>" class="badge bg-light-blue"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                                        <a href="<?php echo e(url('admin/view-earning/'.$vendor->id)); ?>" title="View Earning" class="badge bg-light-blue"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                                        <a href="<?php echo e(url('admin/vendor/withdrawal/request/'.$vendor->id)); ?>" title="Withdrawal Request" class="badge bg-light-blue"><i class="fa fa-inr" aria-hidden="true"></i></a>
                                                        <a  href="<?php echo e(url('admin/delete/'.$vendor->id)); ?>" title="Delete" onclick="return confirm('Are you sure you want to delete this item?');" class="badge bg-red"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                                    </td>
                                                </tr>
                                               <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                         <?php endif; ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cwwwqrxa/domains/apnamal.com/public_html/resources/views/admin/vendor/index.blade.php ENDPATH**/ ?>