          ...
          <div class="nav-tabs-custom">
    			...
    			<div class="col-sm-10">
                    ...
                    <?php if(Auth::user()->user_type == 2): ?>
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="company" required value="<?php echo e(Auth::user()->company); ?>"/> 
                        </div>
                      </div>
                    <?php else: ?>
                     <input type="hidden" class="form-control" name="company" required value=""/>
                    <?php endif; ?>
                      
                <?php if(Auth::user()->user_type == 2): ?>
                      <div class="form-group">
                        <label for="inputExperience" class="col-sm-2 control-label">Company Description</label>
                        <div class="col-sm-10">
                            <textarea class="form-control" rows="7" name="company_description"><?php echo e(Auth::user()->company_description); ?></textarea>
                        </div>
                      </div>
                  <?php else: ?>
                  <input type="hidden" class="form-control" name="company_description" required value=""/>
               <?php endif; ?>
            ...
            <?php if(Auth::user()->user_type == 2): ?>
               <div class="form-group">
                   ...
                   <div class="col-sm-10">
                    ...
                    <?php if(!empty(Auth::user()->avatar)): ?>
                       <img src="<?php echo e(URL::asset('/'.Auth::user()->avatar)); ?>" width="100px"/> 
                     <?php endif; ?>
                   </div>
               </div>
             <?php else: ?>
             ...
             <?php endif; ?>
                ...
                <?php if(Auth::user()->user_type == 2): ?>
                      <div class="form-group">
                        <label for="inputExperience" class="col-sm-2 control-label">Facebook</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="facebook_link" required value="<?php echo e(Auth::user()->facebook_link); ?>"/>
                        </div>
                      </div>
                    <?php else: ?>
                    <input type="hidden" class="form-control" name="facebook_link" required value=""/>
                    <?php endif; ?>
                    
                    <?php if(Auth::user()->user_type == 2): ?>
                      <div class="form-group">
                        <label for="inputExperience" class="col-sm-2 control-label">Twitter</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="twitter_link" required value="<?php echo e(Auth::user()->twitter_link); ?>"/>
                        </div>
                      </div>
                    <?php else: ?>
                    <input type="hidden" class="form-control" name="twitter_link" required value=""/>
                    <?php endif; ?>
                    
                 <?php if(Auth::user()->user_type == 2): ?>
                    <div class="form-group">
                        <label for="inputExperience" class="col-sm-2 control-label">Linkedin</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="linkdein_link" required value="<?php echo e(Auth::user()->linkdein_link); ?>"/>
                        </div>
                    </div>
                    <?php else: ?>
                     <input type="hidden" class="form-control" name="linkdein_link" required value=""/>
                  <?php endif; ?>
                    
                 <?php if(Auth::user()->user_type == 2): ?>
                      <div class="form-group">
                        <label for="inputExperience" class="col-sm-2 control-label">Rss Feed</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="rss_link" required value="<?php echo e(Auth::user()->rss_link); ?>"/>
                        </div>
                      </div> 
                    <?php else: ?>
                     <input type="hidden" class="form-control" name="rss_link" required value=""/>
                  <?php endif; ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cwwwqrxa/domains/apnamal.com/public_html/resources/views/admin/admin/profile.blade.php ENDPATH**/ ?>