...
<?php $__env->startSection('content'); ?>
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Add Leaders <small>Add Leaders ...</small> </h1>
            <ol class="breadcrumb">
                <li><a href="<?php echo e(URL::to('admin/dashboard/this_month')); ?>"><i class="fa fa-dashboard"></i> <?php echo e(trans('labels.breadcrumb_dashboard')); ?></a></li>
                <li><a href="<?php echo e(URL::to('admin/meet-our-leaders')); ?>"><i class="fa fa-dashboard"></i> Meet Our Leaders</a></li>
                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Add Leaders  </h3>
                        </div>
                     ...
                     <?php echo Form::open(array('url' =>'admin/add-meet-our-leaders', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>


                                    <div class="form-group">
                                        <label for="name" class="col-sm-2 col-md-3 control-label">Name</label>
                                        <div class="col-sm-10 col-md-4">
                                            <input type="text" name="name" required value="" class="form-control field-validate">
                                        </div>
                                    </div>
                     
                                    <div class="form-group">
                                        <label for="name" class="col-sm-2 col-md-3 control-label">Designation</label>
                                        <div class="col-sm-10 col-md-4">
                                            <input type="text" name="designation" required value="" class="form-control field-validate">
                                        </div>
                                    </div>
                                ...
                                <!--   <div class="form-group">
                                        ...
                                        <div class="col-sm-10 col-md-8">
                                            <textarea id="editor" name="description" class="form-control field-validate" required rows="10" cols="80"></textarea>
                                        </div>
                                    </div>-->
                                    ...
                                    <div class="form-group">
                                        <label for="name" class="col-sm-2 col-md-3 control-label">Skype Link</label>
                                        <div class="col-sm-10 col-md-4">
                                            <input type="text" name="skype_link" value="" class="form-control field-validate">
                                        </div>
                                    </div>
                                
                                    <div class="form-group">
                                        <label for="name" class="col-sm-2 col-md-3 control-label">Facebook Link</label>
                                        <div class="col-sm-10 col-md-4">
                                            <input type="text" name="facebook_link" value="" class="form-control field-validate">
                                        </div>
                                    </div>
                                
                                    <div class="form-group">
                                        <label for="name" class="col-sm-2 col-md-3 control-label">Linkdin Link</label>
                                        <div class="col-sm-10 col-md-4">
                                            <input type="text" name="linkdin_link" value="" class="form-control field-validate">
                                        </div>
                                    </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/adfsddf/public_html/library/resources/views/admin/About/addmeet_our_leaders.blade.php ENDPATH**/ ?>