...
<div class="ps-page--single">
    ...
    <div class="ps-vendor-banner bg--cover" data-background="<?php echo e(URL::asset('/web/img/bg/vendor.jpg')); ?>" style="background: url(&quot;<?php echo e('/web/img/bg/vendor.jpg'); ?>&quot;);">
        <div class="container">
            <h2>Millions Of Shoppers Can't Wait To See What You Have In Store</h2><a class="ps-btn ps-btn--lg" href="<?php echo e(URL::to('/vendor-registration')); ?>">Start Selling</a>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 ">
                        <div class="ps-block--icon-box-2">
                            <div class="ps-block__thumbnail"><img src="<?php echo e(URL::asset('/web/img/icons/vendor-1.png')); ?>" alt="image"></div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 ">
                        <div class="ps-block--icon-box-2">
                            <div class="ps-block__thumbnail"><img src="<?php echo e(URL::asset('/web/img/icons/vendor-2.png')); ?>" alt="image"></div>
                            <div class="ps-block__content">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12 col-12 ">
                        <div class="ps-block--icon-box-2">
                            <div class="ps-block__thumbnail"><img src="<?php echo e(URL::asset('/web/img/icons/vendor-3.png')); ?>" alt="image"></div>
                            <div class="ps-block__content">
                                <h4>Support 24/7</h4>
                                <div class="ps-block__desc" data-mh="about-desc" style="height: 75px;">
                                    <p>Our tools and services make it easy to manage, promote and grow your business.</p>
        ...
        <div class="container">
            ...
            <div class="ps-section__content">
                <div class="ps-block--vendor-milestone">
                    ...
                    <div class="ps-block__right"><img src="<?php echo e(URL::asset('/web/img/vendor/milestone-1.png')); ?>" alt="image"></div>
                ...
                <div class="ps-block--vendor-milestone reverse">
                    ...
                    <div class="ps-block__right"><img src="<?php echo e(URL::asset('/web/img/vendor/milestone-2.png')); ?>" alt="image"></div>
                ...
                <div class="ps-block--vendor-milestone">
                    ...
                    <div class="ps-block__right"><img src="<?php echo e(URL::asset('/web/img/vendor/milestone-3.png')); ?>" alt="image"></div>
                ...
                <div class="ps-block--vendor-milestone reverse">
                    ...
                    <div class="ps-block__right"><img src="<?php echo e(URL::asset('/web/img/vendor/milestone-4.png')); ?>" alt="image"></div>
    ...
    <div class="ps-section--vendor ps-vendor-best-fees">
        <div class="container">
            ...
            <div class="ps-section__content">
                ...
                <div class="ps-section__highlight"><img src="<?php echo e(URL::asset('/web/img/icons/vendor-4.png')); ?>" alt="image">
                    <figure>
            ...
            <div class="ps-section__content">
                <div class="ps-carousel--nav owl-slider owl-carousel owl-loaded owl-drag" data-owl-auto="true" data-owl-loop="true" data-owl-speed="10000" data-owl-gap="30" data-owl-nav="true" data-owl-dots="true" data-owl-item="2" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="2" data-owl-duration="1000" data-owl-mousedrag="on">
                    ...
                    <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-1230px, 0px, 0px); transition: all 1s ease 0s; width: 4305px;"><div class="owl-item cloned" style="width: 585px; margin-right: 30px;"><div class="ps-block--testimonial">
                                    <div class="ps-block__header"><img src="<?php echo e(URL::asset('web/img/users/2.png')); ?>" alt="image"></div>
                                    ...
                                    <div class="ps-block__header"><img src="<?php echo e(URL::asset('web/img/users/3.jpg')); ?>" alt="image"></div>
                                    <div class="ps-block__content"><i class="icon-quote-close"></i>
                                    ...
                                    <div class="ps-block__header"><img src="<?php echo e(URL::asset('web/img/users/1.jpg')); ?>" alt="image"></div>
                                    <div class="ps-block__content"><i class="icon-quote-close"></i>
    ...
    <div class="ps-section--vendor ps-vendor-faqs">
        <div class="container">
            ...
            <div class="ps-section__footer">
                <p>Still have more questions? Feel free to contact us.</p><a class="ps-btn" href="<?php echo e(URL::to('/contact-us')); ?>">Contact Us</a>
            </div>
        </div>
    </div>
    <div class="ps-vendor-banner bg--cover" data-background="<?php echo e(URL::asset('/web/img/bg/vendor.jpg')); ?>" style="background: url(&quot;<?php echo e(URL::asset('/web/img/bg/vendor.jpg')); ?>&quot;);">
        <div class="container">
            <h2>It's time to start making money.</h2><a class="ps-btn ps-btn--lg" href="<?php echo e(URL::to('/vendor-registration')); ?>">Start Selling</a>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('web.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cwwwqrxa/domains/apnamal.com/public_html/resources/views/web/become_a_vendor.blade.php ENDPATH**/ ?>