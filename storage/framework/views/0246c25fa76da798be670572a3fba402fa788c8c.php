                            ...
                            <div class="col-xs-12">
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 col-md-3 control-label">Admin Charges (%)</label>
                                            <div class="col-sm-10 col-md-4">
                                                <?php echo Form::text($result['settings'][118]->name, $result['settings'][118]->value, array('class'=>'form-control', 'id'=>$result['settings'][118]->name)); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cwwwqrxa/domains/apnamal.com/public_html/resources/views/admin/settings/general/setting.blade.php ENDPATH**/ ?>