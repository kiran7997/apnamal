              		...
              		<div class="box box-info">
                        ...
                        <!-- form start -->
                         <div class="box-body">
                            ...
                            <?php echo Form::open(array('url' =>'admin/advertisement', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>
                                ...
                                <div class="form-group" id="imageIcone">
                                    ...
                                    <div class="col-sm-10 col-md-4">
                                                    ...
                                                    <div class="modal-body manufacturer-image-embed">
                                                        ...
                                                        <select class="image-picker show-html " name="home_right_1" id="select_img">
                                                            ...
                                                            <?php $__currentLoopData = $allimage; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                              <option data-img-src="<?php echo e(asset($image->path)); ?>" class="imagedetail" data-img-alt="<?php echo e($key); ?>" value="<?php echo e($image->id); ?>" <?php if(isset($advertisements->home_right_1) && $advertisements->home_right_1==$image->id){echo 'selected';} ?>> <?php echo e($image->id); ?> </option>
                                        ...
                                        <div  id ="imageselected">
                                                ...
                                                ?>
                                                    <img width="80px" src="<?php echo e(asset($image_categories)); ?>" class="img-circle">
                                                <?php else: ?>
                                                    <img width="80px" src="<?php echo e(asset($image_categories)); ?>" class="img-circle">
                                                <?php endif; ?>
                                            </div>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body manufacturer-image-embed">
                                                                ...
                                                                <select class="image-picker show-html" name="home_right_2" id="select_img">
                                                                    <option value=""></option>
                                                                    <?php $__currentLoopData = $allimage; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                      <option data-img-src="<?php echo e(asset($image->path)); ?>" class="imagedetail" data-img-alt="<?php echo e($key); ?>" value="<?php echo e($image->id); ?>" <?php if(isset($advertisements->home_right_2) && $advertisements->home_right_2==$image->id){echo 'selected';} ?>> <?php echo e($image->id); ?> </option>
                                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                                </select>
                                                                <?php endif; ?>
                                                            </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cwwwqrxa/domains/apnamal.com/public_html/resources/views/admin/Advertisement/advertisement.blade.php ENDPATH**/ ?>