                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <?php echo Form::hidden('products_id',  $products_images[0]->products_id, array('class'=>'form-control', 'id'=>'products_id')); ?>
                                            ...
                                            <div class="modal-body">
                                              ...
                                              <div class="form-group" id="imageIcone">
                                                  <label for="name" class="col-sm-2 col-md-4 control-label"><?php echo e(trans('labels.Icon')); ?></label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        ...
                                                        <img src="<?php echo e(asset($products_images[0]->path)); ?>" alt="" width=" 100px">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-8">
                                                        ...
                                                        <?php echo Form::textarea('htmlcontent',  $products_images[0]->htmlcontent, array('class'=>'form-control', 'id'=>'htmlcontent', 'colspan'=>'3' )); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-8 float-right">
                                                ...
                                                <a type="button" class="btn btn-default"  href="<?php echo e(url('admin/products/images/display')); ?>/<?php echo e($products_images[0]->products_id); ?>"><?php echo e(trans('labels.Close')); ?></a>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/adfsddf/public_html/library/resources/views/admin/products/images/edit.blade.php ENDPATH**/ ?>