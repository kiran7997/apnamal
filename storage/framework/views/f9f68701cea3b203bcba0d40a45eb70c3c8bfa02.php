    ...
    <div class="ps-cart__items">
        ...
        <div class="ps-product--cart-mobile">
            <div class="ps-product__thumbnail">
            	<a href="<?php echo e(URL::to('product-detail/'.$roww->products_slug)); ?>"><img src="<?php echo e(URL::asset('/'.$roww->image_path)); ?>" alt="image"></a></div>
...
</div><?php /**PATH /home/cwwwqrxa/domains/apnamal.com/public_html/resources/views/web/includes/appendCart.blade.php ENDPATH**/ ?>