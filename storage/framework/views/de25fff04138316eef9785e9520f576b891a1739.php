                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="form-group" id="imageIcone">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    ...
                                                    <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;"><?php echo e(trans('labels.WebLogoText')); ?></span>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10 col-md-4">
                                                    ...
                                                    <img src="<?php echo e(asset($result['settings'][16]->path)); ?>" alt="" width="80px">
                                                </div>
                                            </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cwwwqrxa/domains/apnamal.com/public_html/resources/views/admin/settings/general/websetting.blade.php ENDPATH**/ ?>