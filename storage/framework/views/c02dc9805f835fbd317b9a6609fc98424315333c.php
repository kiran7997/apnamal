            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box">
                     ...
                     <?php echo Form::open(array('url' =>'admin/update-category', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>
                             ...
                             <input type="hidden" name="id" value="<?php echo e(isset($id) ? $id : null); ?>"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 col-md-4">
                                        ...
                                        <?php if(count($categories)>0): ?>
                                            ...
                                            <option value="<?php echo e($categorie->id); ?>"<?php if(isset($data->parent_id)){ if($data->parent_id == $categorie->id) { echo 'selected'; }} ?>><?php echo e($categorie->cat_name); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                         <?php endif; ?>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 col-md-4">
                                        <input type="text" name="cat_name" required value="<?php echo e(isset($data->cat_name) ? $data->cat_name : null); ?>" class="form-control field-validate">
                                    </div>
                                </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/adfsddf/public_html/library/resources/views/admin/Blog/edit_category.blade.php ENDPATH**/ ?>