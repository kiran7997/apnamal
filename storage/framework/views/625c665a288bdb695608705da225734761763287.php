                                                            ...
                                                            <div class="box-body">
                                                                ...
                                                                <div class="form-group">
                                                                   ...
                                                                   <?php if(Auth::user()->user_type == 2): ?>
                                                                    <?php
                                                                     $products = DB::table('products')->where('vendor',Auth::user()->id)->get();
                                                                    ?>
                                                                        <select class="form-control field-validate product-type" name="products_id">
                                                                            ...
                                                                            <?php
                                                                              $newest_product_name = DB::table('products_description')->where('products_id',$pro->products_id)->value('products_name');
                                                                            ?>
                                                                            <option value="<?php echo e($pro->products_id); ?>"><?php echo e($newest_product_name); ?></option>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cwwwqrxa/domains/apnamal.com/public_html/resources/views/admin/products/inventory/add1.blade.php ENDPATH**/ ?>