<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview <?php echo e(Request::is('admin/orders/returns') ? 'active' : ''); ?>">
                <a href="<?php echo e(URL::to('admin/orders/returns')); ?>">
                    <i class="fa fa-list-ul" aria-hidden="true"></i><span>Returns</span>
                </a> 
        </li>
        <?php if(Auth()->user()->id == 1): ?>
        <li class=" treeview <?php echo e(Request::is('admin/products/pending') ? 'active' : ''); ?>">
            <a href="<?php echo e(URL::to('admin/products/pending')); ?>">
                <i class="fa fa-circle-o"  aria-hidden="true"></i> Pending Products
            </a>
        </li>
        <?php endif; ?>
<?php
        
        if(@$check->orders_view == 1 or Auth()->user()->user_type == 2){
      ?>
      ...
      <?php }  ?>
    <?php if(Auth()->user()->id == 1): ?>
        <li class="treeview <?php echo e(Request::is('admin/vendor') ? 'active' : ''); ?> <?php echo e(Request::is('admin/edit/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/view-earning/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/vendor/withdrawal/request/*') ? 'active' : ''); ?>">
            <a href="<?php echo e(URL::to('admin/vendor')); ?>">
                <i class="fa fa-user" aria-hidden="true"></i><span>Vendors</span>
            </a> 
        </li>
      <?php endif; ?>
      <?php 
        if(@$check->products_view == 1 or @$check->categories_view == 1 or Auth()->user()->user_type == 2){
      ?>
        <li class="treeview <?php echo e(Request::is('admin/products/display') ? 'active' : ''); ?> <?php echo e(Request::is('admin/products/add') ? 'active' : ''); ?> <?php echo e(Request::is('admin/products/edit/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/editattributes/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/products/attributes/display') ? 'active' : ''); ?>  <?php echo e(Request::is('admin/products/attributes/add') ? 'active' : ''); ?> <?php echo e(Request::is('admin/products/attributes/add/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/addinventory/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/addproductimages/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/categories/display') ? 'active' : ''); ?> <?php echo e(Request::is('admin/categories/add') ? 'active' : ''); ?> <?php echo e(Request::is('admin/categories/edit/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/categories/filter') ? 'active' : ''); ?> <?php echo e(Request::is('admin/products/inventory/display') ? 'active' : ''); ?>">
          ...
          <ul class="treeview-menu">
            ...
            <?php if(@$check->products_view == 1  or Auth()->user()->user_type == 2): ?>
      ...
      <?php } ?>
        ...
        <li class="treeview <?php echo e(Request::is('admin/withdrawal') ? 'active' : ''); ?>">
            <a href="<?php echo e(URL::to('admin/withdrawal')); ?>">
                <i class="fa fa-university" aria-hidden="true"></i><span>Withdrawal</span>
            </a> 
        </li>
        <?php endif; ?>
      
        <?php if(Auth::user()->id == 1): ?>
        <li class="treeview <?php echo e(Request::is('admin/donations') ? 'active' : ''); ?>">
            <a href="<?php echo e(URL::to('admin/donations')); ?>">
                <i class="fa fa-user" aria-hidden="true"></i><span>Donations</span>
            </a> 
        </li>
        <li class="treeview <?php echo e(Request::is('admin/memberships') ? 'active' : ''); ?> <?php echo e(Request::is('admin/memberships/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/membership/*/*') ? 'active' : ''); ?>">
            <a href="<?php echo e(URL::to('admin/memberships')); ?>">
                <i class="fa fa-user" aria-hidden="true"></i><span>Memberships</span>
            </a> 
        </li>
        <?php endif; ?>
        
     <?php if(Auth()->user()->id == 1): ?>
            <li class="treeview <?php echo e(Request::is('admin/about-us') ? 'active' : ''); ?>">
                <a href="#">
                    <i class="fa fa-database" aria-hidden="true"></i>
                    <span>About Us</span> <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                    <li class="<?php echo e(Request::is('admin/about-us') ? 'active' : ''); ?>"><a href="<?php echo e(URL::to('admin/about-us')); ?>"><i class="fa fa-circle-o"></i>About Us</a></li>
                </ul>
            </li>
      <?php endif; ?>
      
     <?php if(Auth()->user()->id == 1): ?>
            <li class="treeview <?php echo e(Request::is('admin/blog-category') ? 'active' : ''); ?> <?php echo e(Request::is('admin/add-category') ? 'active' : ''); ?> <?php echo e(Request::is('admin/edit-category/*') ? 'active' : ''); ?>

                <?php echo e(Request::is('admin/blog') ? 'active' : ''); ?> <?php echo e(Request::is('admin/add-blog') ? 'active' : ''); ?> <?php echo e(Request::is('admin/edit-blog/*') ? 'active' : ''); ?> ">
                <a href="#">
                    <i class="fa fa-database" aria-hidden="true"></i>
                    <span>Blog</span> <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                    <li class="<?php echo e(Request::is('admin/blog-category') ? 'active' : ''); ?> <?php echo e(Request::is('admin/add-category') ? 'active' : ''); ?> <?php echo e(Request::is('admin/edit-category/*') ? 'active' : ''); ?>"><a href="<?php echo e(URL::to('admin/blog-category')); ?>"><i class="fa fa-circle-o"></i>Category</a></li>
                    <li class="<?php echo e(Request::is('admin/blog') ? 'active' : ''); ?> <?php echo e(Request::is('admin/add-blog') ? 'active' : ''); ?> <?php echo e(Request::is('admin/edit-blog/*') ? 'active' : ''); ?>"><a href="<?php echo e(URL::to('admin/blog')); ?>"><i class="fa fa-circle-o"></i>Blog</a></li>
                </ul>
            </li>
      <?php endif; ?>
      ...
      ?>
        ...
        <li class="treeview <?php echo e(Request::is('admin/faq/display') ? 'active' : ''); ?>  <?php echo e(Request::is('admin/faq/add') ? 'active' : ''); ?>  <?php echo e(Request::is('admin/faq/edit/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/faq/filter') ? 'active' : ''); ?> ">
          <a href="<?php echo e(URL::to('admin/faq/display')); ?>">
            <i class="fa fa-users" aria-hidden="true"></i> <span>FAQ's</span>
          </a>
        </li>
      <?php } ?>
      <?php
        ...
        ?>
          <li class="treeview <?php echo e(Request::is('admin/countries/display') ? 'active' : ''); ?> <?php echo e(Request::is('admin/countries/add') ? 'active' : ''); ?> <?php echo e(Request::is('admin/countries/edit/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/zones/display') ? 'active' : ''); ?> <?php echo e(Request::is('admin/zones/add') ? 'active' : ''); ?> <?php echo e(Request::is('admin/zones/eidt/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/tax/taxclass/display') ? 'active' : ''); ?> <?php echo e(Request::is('admin/tax/taxclass/add') ? 'active' : ''); ?> <?php echo e(Request::is('admin/tax/taxclass/edit/*') ? 'active' : ''); ?> <?php echo e(Request::is('admin/tax/taxrates/display') ? 'active' : ''); ?> <?php echo e(Request::is('admin/tax/taxrates/add') ? 'active' : ''); ?> <?php echo e(Request::is('admin/tax/taxrates/edit/*') ? 'active' : ''); ?>">
            ...
            <ul class="treeview-menu">
              ...
              <li class="<?php echo e(Request::is('admin/zones/pincodes/display') ? 'active' : ''); ?> <?php echo e(Request::is('admin/zones/pincodes/add') ? 'active' : ''); ?> <?php echo e(Request::is('admin/zones/pincodes/eidt/*') ? 'active' : ''); ?>"><a href="<?php echo e(URL::to('admin/zones/pincodes/display')); ?>"><i class="fa fa-circle-o"></i> Pincodes</a></li>
...
<span><?php echo e(trans('labels.link_notifications')); ?></span> <i class="fa fa-angle-left pull-right"></i>
  ...
  <span> <?php echo e(trans('labels.link_site_settings')); ?></span> <i class="fa fa-angle-left pull-right"></i>
          ...
          <ul class="treeview-menu">
            ...
            <li class="<?php echo e(Request::is('admin/home-comic') ? 'active' : ''); ?>"><a href="<?php echo e(URL::to('admin/home-comic')); ?>"><i class="fa fa-circle-o"></i>Home Page Comic</a></li>
          </ul>
        </li>
      <?php } ?>
      <?php
  ...
  <span> <?php echo e(trans('labels.link_general_settings')); ?></span> <i class="fa fa-angle-left pull-right"></i>
          ...
          <ul class="treeview-menu">
            ...
            <li class="<?php echo e(Request::is('admin/advertisement') ? 'active' : ''); ?>"><a href="<?php echo e(URL::to('admin/advertisement')); ?>"><i class="fa fa-circle-o"></i> Advertisement</a></li>
  ...
  <span> <?php echo e(trans('labels.Managements')); ?></span> <i class="fa fa-angle-left pull-right"></i>
          ...
          <ul class="treeview-menu">
            <li class="<?php echo e(Request::is('admin/managements/updater') ? 'active' : ''); ?>"><a href="<?php echo e(URL::to('admin/managements/backup')); ?>"><i class="fa fa-circle-o"></i> <?php echo e(trans('labels.Back Up / Restore')); ?></a></li>
            <li class="<?php echo e(Request::is('admin/managements/updater') ? 'active' : ''); ?>"><a href="<?php echo e(URL::to('admin/managements/import')); ?>"><i class="fa fa-circle-o"></i> <?php echo e(trans('labels.Import Data')); ?></a></li>
...
<?php /**PATH /home/cwwwqrxa/domains/apnamal.com/public_html/resources/views/admin/common/sidebar.blade.php ENDPATH**/ ?>