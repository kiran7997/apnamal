...
<!--                                            <th><?php echo e(trans('labels.Additional info')); ?></th>-->
                                                 ...
                                                 ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <img src="<?php echo e(asset(DB::table('image_categories')->where('image_id',$product->products_image)->value('path'))); ?>" alt="" height="50px">
                                                            <?php else: ?>
                                                            <img src="<?php echo e($product->url); ?>" alt="" height="50px">
                                                            <?php endif; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo e(isset($category_name) ? $category_name : null); ?>

                                                        </td>
                                                        <td>
                                                            <?php echo e(isset($products_name) ? $products_name : null); ?>
    ...
    <!--                                                    <td>
                                                        ...
                                                        <td>
                                                            <a data-toggle="tooltip" data-placement="bottom" title="Approve Product" href="approveProduct/<?php echo e($product->products_id); ?>" class="badge bg-light-blue"><i class="fa fa-check-square-o" aria-hidden="true"></i><span> Approve</span></a>
                                                            <a data-toggle="tooltip" data-placement="bottom" title="Decline Product" href="declineProduct/<?php echo e($product->products_id); ?>" class="badge bg-red"><i class="fa fa-times" aria-hidden="true"></i><span> Decline</span></a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            <?php else: ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cwwwqrxa/domains/apnamal.com/public_html/resources/views/admin/products/pending.blade.php ENDPATH**/ ?>