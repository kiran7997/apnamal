        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-lg-3 col-xs-6">
                  ...
                  <div class="small-box bg-aqua">
                    <div class="inner">
                        <h4><?php echo e($result['currency'][19]->value); ?> <b><?php echo e(number_format($result['sold_cost_vendor_completed'],2)); ?></b></h4>
                        <p>Total Earnings</p>
                    </div>
                    <div class="icon">
                      <i class="ion ion-bag"></i>
                    </div>
                    <a href="javascript:;" class="small-box-footer" data-toggle="tooltip" data-placement="bottom"></a>
                  </div>
                </div>
                <!-- ./col -->
                <div class="col-lg-3 col-xs-6">
                  ...
                  <div class="small-box bg-light-blue">
                    <div class="inner">
                        <h4><?php echo e($result['currency'][19]->value); ?> <b><?php echo e(number_format(($result['sold_cost_vendor']*$result['settings'][118]->value)/100,2)); ?></b></h4>
                        <p>Admin Charge</p>
                    </div>
                    <div class="icon">
                      <i class="ion ion-bag"></i>
                ...
                <div class="col-lg-3 col-xs-6">
                  ...
                  <div class="small-box bg-teal">
                    <div class="inner">
                        <h4><?php echo e($result['currency'][19]->value); ?> <b><?php echo e(number_format($result['sold_cost_vendor_pending'],2)); ?></b></h4>
                ...
                <div class="col-lg-3 col-xs-6">
                  <div class="small-box bg-green">
                    <div class="inner">
                        <h4><?php echo e($result['total_product']); ?></b></h4>
                        <p>Total Products</p>
                    </div>
                    <div class="icon">
                      <i class="ion ion-stats-bars"></i>
                                            ...
                                            <?php
                                             $price = 0;
                                               ...
                                               $orderss = DB::table('orders')
                                                       ...
                                                       ->select('orders_products.final_price as pricee')
                                            ...
                                            ?>
                                                <?php if($key<=10): ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo e($orders->customers_name); ?></td>
                                                       <?php if(Auth::user()->user_type == 2): ?>
                                                        <td><?php echo e($result['currency'][19]->value); ?><?php echo e(floatval($price)); ?> </td>
                                                        <?php else: ?>
                                                        <td><?php echo e($result['currency'][19]->value); ?><?php echo e(floatval($orders->total_price)); ?> </td>
                                                      <?php endif; ?>
                                                        <td>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cwwwqrxa/domains/apnamal.com/public_html/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>