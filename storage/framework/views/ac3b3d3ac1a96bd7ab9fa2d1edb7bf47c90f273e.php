                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        ->where('products.vendor',Auth()->user()->id)->select('orders_products.final_price as pricee')
                                        ->where('orders.orders_id',$orderData->orders_id)
                                        ->get();
                                            ...
                                            ?>
                                                <tr>
                                                  ...
                                                  <?php if(Auth::user()->user_type == 2): ?>
                                                   <td><?php echo e($listingOrders['currency'][19]->value); ?><?php echo e($price); ?></td>
                                                    <?php else: ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cwwwqrxa/domains/apnamal.com/public_html/resources/views/admin/Orders/index.blade.php ENDPATH**/ ?>