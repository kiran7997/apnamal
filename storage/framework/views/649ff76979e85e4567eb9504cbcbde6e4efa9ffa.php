      ...
      <div class="row">
        <div class="col-xs-12 table-responsive">
          <table class="table table-striped">
            ...
            <?php $chk_vendor = DB::table('products')->where('products_id',$products->products_id)->value('vendor'); ?>
            <?php if(Auth()->user()->id==1): ?>
            <tr>
...
<!--                <td>
            ...
            <?php elseif($chk_vendor==Auth()->user()->id): ?>
            <tr>
                <td><?php echo e($products->products_quantity); ?></td>
                <td >
                   <img src="<?php echo e(asset('').$products->image); ?>" width="60px"> <br>
      ...
      <div class="row">
        ...
        <div class="col-xs-6">
          ...
          <p class="text-muted well well-sm no-shadow" style="text-transform:capitalize; word-break:break-all;">
           <?php if(trim($data['orders_data'][0]->order_information) != '[]' || !empty($data['orders_data'][0]->order_information)): ?>
               <?php if(isset($data['orders_data'][0]->order_information)): ?>
                    <i>NA</i>
               <?php else: ?>
     ...
     <?php echo Form::hidden('customers_id', $data['orders_data'][0]->customers_id, array('class'=>'form-control', 'id'=>'device_id')); ?>
        ...
        <hr>
         ...
         <!-- this row will not appear when printing -->
            <div class="col-xs-12">
              <a href="<?php echo e(URL::to('admin/orders/display')); ?>" class="btn btn-default"><i class="fa fa-angle-left"></i> <?php echo e(trans('labels.back')); ?></a>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cwwwqrxa/domains/apnamal.com/public_html/resources/views/admin/Orders/vieworder.blade.php ENDPATH**/ ?>