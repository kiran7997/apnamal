...
<?php $__env->startSection('content'); ?>
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <h1>Add Blog<small>Add Blog ...</small> </h1>
            <ol class="breadcrumb">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box">
                     ...
                     <?php echo Form::open(array('url' =>'admin/add-blog', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')); ?>
                             ...
                             <input type="hidden" name="id" value=""/>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 col-md-4">
                                        <input type="text" name="title" required value="" class="form-control field-validate">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10 col-md-4">
                                        <textarea name="description" rows="5" class="form-control field-validate" required></textarea>
                                    </div>
                                </div>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cwwwqrxa/domains/apnamal.com/public_html/resources/views/admin/Blog/addblog.blade.php ENDPATH**/ ?>