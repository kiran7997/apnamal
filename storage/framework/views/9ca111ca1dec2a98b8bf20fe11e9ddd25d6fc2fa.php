                ...
                <div class="col-md-12">
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title"><?php echo e(trans('labels.pushNotification')); ?> </h3>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="box box-info">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <div class="onesignal_content" <?php if($result['settings'][54]->value == 'onesignal'): ?>
                                            style="display: block;"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        <?php echo Form::text($result['settings'][55]->name,  $result['settings'][55]->value, array('class'=>'form-control', 'id'=>$result['settings'][55]->name)); ?>
                                ...
                                <?php echo e(trans('labels.OnesignalAppidText')); ?></span>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10 col-md-4">
                                                        <?php echo Form::text($result['settings'][56]->name,  $result['settings'][56]->value, array('class'=>'form-control', 'id'=>$result['settings'][56]->name)); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cwwwqrxa/domains/apnamal.com/public_html/resources/views/admin/settings/general/pushNotification.blade.php ENDPATH**/ ?>