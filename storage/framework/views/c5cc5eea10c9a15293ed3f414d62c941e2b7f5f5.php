...
<main class="ps-page--my-account">
    ...
    <section class="ps-section--account">
        <div class="container">
            <div class="row">
                <?php echo $__env->make('web.includes.vendor_sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <div class="col-lg-8">
...
<?php echo $__env->make('web.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/adfsddf/public_html/library/resources/views/web/vendor_profile.blade.php ENDPATH**/ ?>