                                ...
                                <div class="box box-info">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10 col-md-4">
                                                <?php echo Form::hidden('old_email_address', $data['customers']->email, array('class'=>'form-control', 'id'=>'old_email_address')); ?>

                                                <?php echo Form::email('email', $data['customers']->email, array('class'=>'form-control email-validate', 'id'=>'email')); ?>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cwwwqrxa/domains/apnamal.com/public_html/resources/views/admin/customers/edit.blade.php ENDPATH**/ ?>