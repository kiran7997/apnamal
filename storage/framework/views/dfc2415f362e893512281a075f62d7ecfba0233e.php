...
<!--                                            <th><?php echo e(trans('labels.Image')); ?></th>
                                        ...
                                        <?php if(count($categories)>0): ?>
                                            ...
                                            $mainparent = '';
                                            if($category->level==2){
                                                $parent = DB::table('categories')->where('categories_id',$category->parent_id)->first();
                                                if(isset($parent->parent_id)){
                                                    $mainparent = DB::table('categories_description')->where('categories_id',$parent->parent_id)->value('categories_name');
                                                }
                                            }elseif($category->level==1){
                                                if(isset($category->parent_id)){
                                                    $mainparent = DB::table('categories_description')->where('categories_id',$category->parent_id)->value('categories_name');
                                                }
                                            }
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo e(!empty($parent) ? DB::table('categories_description')->where('categories_id',$parent->categories_id)->value('categories_name') : '-'); ?></td>
                                                        <td><?php echo e(!empty($mainparent) ? $mainparent : '-'); ?></td>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/cwwwqrxa/domains/apnamal.com/public_html/resources/views/admin/categories/index.blade.php ENDPATH**/ ?>